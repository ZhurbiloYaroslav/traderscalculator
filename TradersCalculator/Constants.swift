...
struct Constants {
    ...
    static let instaForexBaseURL = "https://quotes.instaforex.com/api/quotesTick?m=json&q=USDRUR,AUDUSD,EURUSD,GBPUSD,USDCAD,USDCHF,USDJPY,AUDCAD,AUDCHF,AUDJPY,AUDNZD,CADCHF,CADJPY,CHFJPY,EURAUD,EURCAD,EURCHF,EURGBP,EURJPY,EURNZD,GBPAUD,GBPCAD,GBPCHF,GBPJPY,GBPNZD,NZDCAD,NZDCHF,NZDJPY,NZDUSD,USDSGD,AUDSGD,CHFSGD,EURDKK,EURHKD,EURNOK,EURPLN,EURSEK,EURSGD,EURTRY,EURZAR,GBPDKK,GBPNOK,GBPSEK,GBPSGD,NOKJPY,NOKSEK,SEKJPY,SGDJPY,USDCNH,USDCZK,USDDKK,USDHKD,USDHUF,USDMXN,USDNOK,USDPLN,USDRUR,USDSEK,USDTHB,USDTRY,USDZAR,BTCUSD,XBRUSD,%23bitcoin"
}
